describe('Создание новой вакансии работодателем', () => {
  it('Создастся новая вакансия', () => {
    ...
    cy.get('.vacancy-add-form-wrapper > .form > :nth-child(1) > .form__labels > .labels > :nth-child(1) > .form-control--responsive > .form-input--').type('Тестовая вакансия', {force: true});
    ...
    cy.get('.vacancy-add-form-wrapper > .form > :nth-child(1) > .form__labels > .labels > :nth-child(5) > .form-control > .form-area').type('Нам нужен ответственный исполнитель!', {timeout: 3000});
